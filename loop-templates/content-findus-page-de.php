...
<article id="post-<?php the_ID(); ?>">
		...
		<div class="row container-fluid--boxed content-item">
				...
				<div class="col-md-6 d-flex align-items-start flex-column findus-form">
					<select id="sel" onchange='changePlace(this.value)'>
						<option value="all">Supermärkte &amp; Restaurants</option>
                		<option value="STORE">Supermärkte</option>
                		<option value="RESTAURANT">Restaurants</option>
					</select>
					<input type="text" id="location-input" class="form-control form-control-lg" aria-describedby="basic-addon1" placeholder="Suche nach Stadt, Adresse, etc." />
					
					<button class="btn btn-outline-secondary" id="location-submit" type="submit" onclick="runAutocomplete(event)">Submit</button>
					<button class="button button--black btn-locate-me" id="location-getMylocation" onclick="getMyLocation(event)">Deinen Standort verwenden</button>
	...
	<div class="row">
			...
			<div class="col-md-6">
				...
				<span class="active" id="showMapResults" onclick="showMapResults(event)"> KARTE</span>
			</div>
        <div id="map"></div>
		<div id="noResults">
					<p>Huch, es scheint, als können wir den gewünschten Standort von Dir nicht finden. Aber wir sind in diesen europäischen Ländern zu finden:</p>
