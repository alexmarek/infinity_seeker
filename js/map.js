        ...
        if (allmarkers[i].category === value) {
            ...
            listResultsContainer.innerHTML += `
                    <div class="container info info-${i + 1}">
                        <div class="row">
                            <div><span>${allmarkers[i].category}</span></div>
                            <div class="col-1-of-4"><h4>${allmarkers[i].organization}</h4></div>
                            <div class="col-2-of-4"><p>${allmarkers[i].address}, ${allmarkers[i].postcode} ${allmarkers[i].country}</p></div>
                            <div class="col-1-of-4"><h5 data-coordinates="${allmarkers[i].position}" onclick="showMeDirection(this)">Directions</h5></div>
                        </div>
                    </div>
                `;
            infoPanel = $('.info-' + (i + 1));
